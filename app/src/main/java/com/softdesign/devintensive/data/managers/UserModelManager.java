...
public class UserModelManager {
    ...
    public static void saveUserModelToPreferenses(DataManager dataManager, GetUserRes userModel) {
        ...
        if (userModel.getData().getRepositories().getRepo()!=null) {
        ...
        dataManager.getPreferencesManager().saveUserFio(userModel.getData().getFirstName()+" "+userModel.getData().getSecondName());
        dataManager.getPreferencesManager().saveUserProfileData(userFields);
        Uri uri = Uri.parse(userModel.getData().getPublicInfo().getPhoto());
        dataManager.getPreferencesManager().saveUserPhoto(uri);
        uri = Uri.parse(userModel.getData().getPublicInfo().getAvatar());
        dataManager.getPreferencesManager().saveUserAvatar(uri);
