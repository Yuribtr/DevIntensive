...
public class DatabaseAsyncLoader extends Loader<String> {
    ...
    public DatabaseAsyncLoader(Context context, Bundle args) {
        super(context);
    ...
    class GetTimeTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            Log.d(LOG_TAG, this.hashCode() + " doInBackground");
            try {
        ...
        protected void onPostExecute(String result) {
            ...
            Log.d(LOG_TAG, this.hashCode() + " onPostExecute "
                    + result);
